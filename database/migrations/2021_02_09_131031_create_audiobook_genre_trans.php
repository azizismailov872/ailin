...
class CreateAudiobookGenreTrans extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('audiobook_genre_trans', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('genre_id')->references('id')->on('audiobook_genres')->onDelete('cascade');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('audiobook_genre_trans');
    }
}
