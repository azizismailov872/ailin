...
class CreatePodcastGenreTransTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('podcast_genre_trans', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('genre_id')->references('id')->on('podcast_genres')->onDelete('cascade');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('podcast_genre_trans');
    }
}
