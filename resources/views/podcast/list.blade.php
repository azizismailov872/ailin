	...
	<div class="container-fluid">
		<div class="row">
			<div class="row title-page-block">
				<div class="col-12">
					<h1 class="display-2 title-page text-uppercase" aria-label="@lang('main.podcasts')">@lang('main.podcasts')</h1>
							...
							<div id="myCarousel" data-bs-interval="false" class="carousel slide carousel-dark" data-bs-ride="carousel">
								...
								<div class="carousel-inner">
								    <div class="carousel-item active">
										<div class="row">
											@foreach($list as $podcast)
												@include('podcast.parts.podcast',['model' => $podcast])
											@endforeach
								     	</div>
								    </div>
							  	</div>
