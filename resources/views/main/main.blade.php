		...
		<div class="row">
			<div class="col-4 col-xs-12 col-md-4 col-sm-12">
				<nav class="nav main-nav flex-column">
				  	<a class="nav-link color-black" href="#" tabindex="0">ГЛАВНАЯ</a>
				  	<a class="nav-link color-black" href="#" tabindex="0">ИСТОРИЯ</a>
				  	<a class="nav-link color-black" href="#" tabindex="0">АУДИОКНИГИ</a>
				  	...
				  	<a class="nav-link color-black" href="#" tabindex="0">ОБ AILIN</a>
				</nav>
			</div>
