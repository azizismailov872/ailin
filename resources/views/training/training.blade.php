            ...
            <div class="row title-page-block mb-2">
                <div class="col-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                        	<li class="breadcrumb-item text-uppercase"><a href="{{route('trainings.genres')}}">@lang('main.trainings')</a></li>
                            <li class="breadcrumb-item text-uppercase"><a href="{{route('trainings.list',$model->genre->slug)}}">{{$model->getGenreTitle()}}</a></li>
